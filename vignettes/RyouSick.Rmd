...
```{r, include = FALSE}
#THIS BLOCK IS NOT SEEN IN KNITTED VERSION - external data loaded as seed cannot be set in examples 
bad_knee_data <- RyouSick::OpenRds(tools::file_path_sans_ext(system.file("extdata", "bad_knee_data.rds", package = "RyouSick")))
