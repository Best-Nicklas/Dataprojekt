...
If we want to visually compare the accumulated power for each of the methods, we can use the function `Power_plots()`. First we need to save the GWAS_data for each method in a list format. For illustrative purposes we set the pvalue threshold to 0.5. 
