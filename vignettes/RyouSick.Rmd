...
This information can now be used in the `Predict_status()` to predict a status for future genotypes. For illustrative purposes we will use our old data again, as the input needs to be formatted as an rds object.
