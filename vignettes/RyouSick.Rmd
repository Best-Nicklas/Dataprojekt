...
```{r, eval = FALSE}
bad_knee_data <- sim_genotypes_with_family(n = 10, disease = bad_knee_syndrome, path = "bad_knee_data", n_sibs = c(1,2,3))
```
...
```{r}
knitr::kable(get_stats(pvalues = x$p.value, true_causal = bad_knee_syndrome$CAUSAL, threshold_pvalue = 0.05))
```
