...
We can easily compare and choose the best model for predicting as seen in the above figure. Note that the alpha level is decreasing on the x-axis. We can now predict a status for a new person and be comfortable that we have the best model that we can create to do so. 
