...
gwax_pred <- prediction_cross_validation(........)
gwax_pred$Results
ltfh_pred <- prediction_cross_validation(........)
ltfh_pred$Results
...
new_pred <- prediction_status(new_persons,.....)
