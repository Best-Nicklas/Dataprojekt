#' @title Constants for normalization
#' @description This function calculates the theoretical value of the constants mu and sigma, which are used to normalize the data. 
