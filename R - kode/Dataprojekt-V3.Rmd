...
Parent_1_fbm <- CreateFBM(n,n, "../Data/Parent_1_test2")
Parent_2_fbm <- CreateFBM(n,n, "../Data/Parent_2_test2")
...
rds_Parent_1 <- OpenRds("../Data/Parent_1_test2.rds")
rds_Parent_2 <- OpenRds("../Data/Parent_2_test2.rds")

print(rds_Parent_1)
print(rds_Parent_2)

child_test <- Simulate_child(Parent_1_fbm, Parent_2_fbm, "../Data/Child_2_test")
Simulate_FAM_MAP(child_test, MAF, Causal_SNPs, 0.8)
child_test <- OpenRds("../Data/Child_2_test.rds")
print(child_test)
