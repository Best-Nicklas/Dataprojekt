...
#' 
#' @param Gwas_data A list with exactly three entrances, with the GWAS-data obtained from from each model (GWAS, GWAX and LTFH), where the data from GWAS has to be the first entrance, the data from Gwax has to be the second entrance and the data from LTFH has to be on the last entrance. 
#' @param a significance level used to determine causal SNPs
#' @return Ggplot object with power plots from GWAS, GWAX and LTFH, to get a visual comparison of the prediction power for each model. 
#' @export
#' 
